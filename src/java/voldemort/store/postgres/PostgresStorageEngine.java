 ...
 * 
 */
public class PostgresStorageEngine extends AbstractStorageEngine<ByteArray, byte[], byte[]> {

    private static final Logger logger = Logger.getLogger(PostgresStorageEngine.class);
    private static int POSTGRES_ERR_DUP_KEY = 23505;
    ...
    public ClosableIterator<Pair<ByteArray, Versioned<byte[]>>> entries() {
        ...
        try {
            ...
            stmt = conn.prepareStatement(select);
            rs = stmt.executeQuery();
            return new PostgresClosableIterator(conn, stmt, rs);
        } catch(SQLException e) {
    ...
    public void put(ByteArray key, Versioned<byte[]> value, byte[] transforms)
        ...
        try {
            ...
            if(e.getErrorCode() == POSTGRES_ERR_DUP_KEY) {
    ...
    private class PostgresClosableIterator implements
        ...
        public PostgresClosableIterator(Connection connection,
