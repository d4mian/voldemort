 ...
 * 
 */
public abstract class RdbmsStorageEngine extends AbstractStorageEngine<ByteArray, byte[], byte[]> {

    private static final Logger logger = Logger.getLogger(RdbmsStorageEngine.class);
    protected final DataSource datasource;

    protected abstract boolean tableExists();

    protected abstract void create();

    protected abstract boolean areKeyOrValueAlreadyInUse(SQLException e);

    public RdbmsStorageEngine(String name, DataSource datasource) {
        super(name);
    ...
    public ClosableIterator<Pair<ByteArray, Versioned<byte[]>>> entries() {
        ...
        try {
            ...
            return new RdbmsClosableIterator(conn, stmt, rs);
        } catch(SQLException e) {
    ...
    public void put(ByteArray key, Versioned<byte[]> value, byte[] transforms)
        ...
        try {
            ...
            if(areKeyOrValueAlreadyInUse(e)) {
    ...
    private class RdbmsClosableIterator implements
        ...
        public RdbmsClosableIterator(Connection connection,
